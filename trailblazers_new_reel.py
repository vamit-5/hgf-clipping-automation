...
def find_single_hook_segment(words, api_key, total_duration, content_criteria):
    ...
    prompt = (
        ...
        "leadership is...', 'and i think as...', 'so i think...', 'so basically what happened "
        "is...' - bilo koja recenica koja pocinje sa 'and/so I think' ili slicnim mekim uvodom "
        "- ovakve recenice ne otkrivaju NISTA konkretno i NE SME biti prva recenica u klipu, cak "
        "i ako je to gde tema realno pocinje u transkriptu - u tom slucaju TRAZI DRUGI segment "
        "koji ima jaci, konkretniji pocetak, ili pomeri pocetak klipa unapred/unazad do prve "
        "stvarno jake recenice unutar iste teme.\n"
